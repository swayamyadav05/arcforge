...
The application runs at `http://localhost:3000`. Navigate to `/quiz` to go through the full arc generation flow, or visit `/arc/i38CqFEH` to see a sample arc's public share page.
